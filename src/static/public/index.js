...
const url= 'http://127.0.0.1:5000/datos/iniciosesion'
submitButton.addEventListener('click', async (event) => {
    ...
    .then(data => {
        ...
        if (isUserValid) {
            ...
            if (tipo == 1) {
            window.location.replace('http://127.0.0.1:5000/admin/ventas');
            console.log(tipo);
            } else {
            window.location.replace('http://127.0.0.1:5000/empleado/orden');
            console.log(tipo);
            }
        } else {
